...
`cd ~ && git clone https://github.com/bepoisso/My_Zsh.git && mv ~/.zshrc ~/.old_zshrc && cp ~/My_Zsh/zshrc ~/.zshrc && cp ~/My_Zsh/themes/flitcher.zsh-theme ~/.oh-my-zsh/themes/ && source ~/.zshrc`
